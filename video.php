...
<script>
    $(document).ready(function() {
        ...
        function searchArtists(inputElement) {
            ...
            // Make AJAX request
            $.ajax({
                url: 'search_albums.php?searchByAlbum=false&searchFromAllMusic=false&searchFromAllVideo=true',
                type: 'GET',
                data: {
                    search: searchValue
                },
        ...
        function highlightSearchTerm(term) {
            ...
            $('.highlighting-search').each(function() {
                ...
                artistDiv.find('h4, p').each(function() {
                    ...
                    var newHtml = elementText.replace(regex, '<span class="highlight mx-2 rounded">$1</span>');
        ...
        <div class="row">
            <div class="col-xl-5">
                <form method="get">
                    <div class="form-outline" data-mdb-input-init>
                        <input type="search" id="search" name="search" class="form-control" placeholder="Search Video Track" style="border-radius: 50px; width:250px; float:left;" />
                    </div>
            ...
            <div class="col-xl-7">
                <div class="section_title text-left mb-65">
                    <h3 class="text-warning">Video Tracks</h3>
                </div>
            </div>
        </div>

...
<div class="music_area music_gallery">
    <div class="container">
        ...
        <div class="row align-items-center justify-content-center mb-20">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div class="music_field">
                                ...
                                <h2><div class="fav"><a href="favourite.php?video_id=<?php echo $row[0]?>" ><i class="fa fa-heart"></i> <p class="fav2 text-light">Add to Favourites</p></a></div><?php echo $row[1]?></h2>
                                    <p><?php echo $row[2]?></p>
                                    <video preload="auto" poster="<?php echo substr($row[8], 3, 100) ?>" height="250px" width="500px"
                                        controls>
                                        <source
                                            src="<?php echo substr($row[9], 3, 100) ?>">
                                    </video>
                                </div>
                                </div>
                            </div>
            ...
            <?php }
                    }else{$empty = "<span class='text-danger'>Video Not Found</span>"; echo $empty;} ?>
        </div>
    </div>
</div>
<!-- music_area end  -->
